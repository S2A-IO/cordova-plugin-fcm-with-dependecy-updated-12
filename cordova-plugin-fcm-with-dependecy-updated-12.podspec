#
#  Be sure to run `pod spec lint cordova-plugin-fcm-with-dependecy-updated-12.podspec' to ensure this is a
...
DESC
  ...
  spec.homepage     = "https://github.com/JaimeHere/cordova-plugin-fcm-with-dependecy-updated-12"
  ...
  spec.source       = { :git => "https://github.com/JaimeHere/cordova-plugin-fcm-with-dependecy-updated-12.git", :tag => "v#{spec.version}" }
